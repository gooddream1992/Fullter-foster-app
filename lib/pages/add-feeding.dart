...
class AddFeedingLog extends StatefulWidget {
  @override
  _AddFeedingLog createState() => new _AddFeedingLog();
}

class _AddFeedingLog extends State<AddFeedingLog> {
  AppState state;
  String error = '';
  bool status = false;
  ...
  void submit() {
    ...
    state.postAuth(
        context, 'create-foster-feeding/' + state.foster['id'].toString(), {
      'date': date.text,
      'time': time.text,
      'type': type.text,
      'amount': amount.text,
