...
class EditFosterPage extends StatefulWidget {
  @override
  _EditFosterPage createState() => new _EditFosterPage();
}

class _EditFosterPage extends State<EditFosterPage> {
  AppState state;
  String error = '';
  bool status = false;
  String species = '';
  ...
  void initState() {
    ...
    if (state.foster['name'] != null) {
      name.text = state.foster['name'];
    }
    if (state.foster['dob'] != null) {
      birthdate.text = state.foster['dob'];
    }
    if (state.foster['species'] != null) {
      species = state.foster['species'];
    }
  }
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text('Update Selected Foster'),
            ...
            children: <Widget>[
              ...
              new Container(
                ...
                child: new DropdownButtonFormField(
                  ...
                  value: species != null ? species : null,
                  items: [
  ...
  void submit(id) {
    ...
    state.postAuth(context, 'update-foster/' + id.toString(), {
      'name': name.text,
      'species': species,
      'dob': birthdate.text,
    }).then((data) {
